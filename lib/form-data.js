...
export class FormData {
    ...
    process() {
        ...
        this.properties = extractProperties({
            graph: this.submission.submittedDocument.graph,
            base: this.submission.submittedDocument.uri
        });
    }
...
INSERT {
  GRAPH ?g {
    ...
    ${sparqlEscapeUri(this.uri)} ${sparqlEscapeUri(PROV('hadPrimarySource').value)} ${sparqlEscapeString(this.submission.submittedDocument.location)} .
