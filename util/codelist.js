...
export const TAX_TYPES =
  'http://lblod.data.gift/concept-schemes/3037c4f4-1c63-43ac-bfc4-b41d098b15a6';
export const ADOPTION_TYPES =
  'http://lblod.data.gift/concept-schemes/a995bb71-3c87-4385-a06b-a786f2fa0d16';
export const MUNICIPAL_ROAD_PROCEDURE_TYPES =
  'http://lblod.data.gift/concept-schemes/60d620a5-ec34-4a91-ba84-fff0813d0ccc';
...
export async function retrieveCodeList(uri) {
  try {
    ...
    console.log(
      'Something went wrong while trying to retrieving the code-list.'
    );
